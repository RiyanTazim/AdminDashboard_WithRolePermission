...
class DynamicPageController extends Controller
{
    public function index()
    {
        ...
        return view('Backend.Layout.DynamicPage.list');
    }
    ...
    {
        return view('Backend.Layout.DynamicPage.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Backend.Layout.DynamicPage.edit', compact('dynamicpage'));
    }
