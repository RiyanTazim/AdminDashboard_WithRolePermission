        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="rolePermission" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
...
@push('scripts')
    ...
    <script>
        ...
        const deleteRouteBase = "{{ route('role.delete', ':id') }}";
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#rolePermission').DataTable().ajax.reload();
