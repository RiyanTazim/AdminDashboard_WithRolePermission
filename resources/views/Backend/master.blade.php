...
<head>
    ...
    <title>
        @if (auth()->check())
            @if (auth()->user()->hasRole('admin'))
                Admin Dashboard
            @else
                {{ ucfirst(auth()->user()->roles->pluck('name')->first()) }} Dashboard
            @endif
        @else
            Dashboard
        @endif
    ...
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/backend/css/demo2/style.css">
    <!-- End layout styles -->
...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <main style="min-height: calc(100vh - 56px);" class="pt-4">
                @yield('admin')
            </main>
    ...
    <script src="{{ asset('/') }}assets/backend/js/code/code.js"></script>
